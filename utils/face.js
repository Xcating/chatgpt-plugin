  ...
  if (handleAt) {
    ...
    if (groupMembers) {
      for (let key of groupMembers.keys()) {
        groupCardQQMap[
          groupMembers.get(key).card || groupMembers.get(key).nickname
    ...
    if (!foundFace) {
      ...
      if (handleAt && foundAt) {
        ...
        if (groupCardQQMap[tmpAt]) {
          ...
          msgs.push(
            segment.at(
              groupCardQQMap[tmpAt],
              groupMembers.get(groupCardQQMap[tmpAt]).card,
              false
            )
          );
          tmpAt = "";
      ...
      if (msg[i] !== "]") {
        ...
        foundFace = false;
        if (
          faceMapReverse[tmpFace] ||
          faceMapReverse["/" + tmpFace] ||
          faceMapReverse[_.trimStart(tmpFace, "/")]
        ) {
          if (tmpMsg) {
            msgs.push(tmpMsg);
          }
