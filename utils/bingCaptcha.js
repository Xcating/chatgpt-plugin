...
export async function createCaptcha(e, tokenU) {
  ...
  let imageResponse = await newFetch(
    `${baseUrl}/edgesvc/turing/captcha/create`,
    {
      headers: {
        Cookie: `_U=${tokenU};`,
        "User-Agent":
        ...
        Referer:
          "https://edgeservices.bing.com/edgesvc/chat?udsframed=1&form=SHORUN&clientscopes=chat,noheader,channelstable,&shellsig=ddb7b7dc7a56d0c5350f37b3653696bbeb77496e&setlang=zh-CN&lightschemeovr=1",
      },
    }
  );
