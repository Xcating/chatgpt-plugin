    ...
    configInfo: {
      ...
      schemas: [
        ...
        },
        {
          ...
          bottomHelpMessage:
            "前往duplicate空间https://huggingface.co/spaces/ikechan8370/vits-uma-genshin-honkai后查看api地址",
          component: "Input",
        },
        {
          field: "voicevoxSpace",
          ...
          bottomHelpMessage:
            "可使用https://2ndelement-voicevox.hf.space, 也可github搜索voicevox-engine自建",
          component: "Input",
        },
        {
          field: "azureTTSKey",
        ...
        },
        {
          ...
          label: "Azure情绪多样化",
          bottomHelpMessage:
            '切换角色后使用"#chatgpt使用设定xxx"重新开始对话以更新不同角色的情绪配置。支持使用不同的说话风格回复，各个角色支持说话风格详情：https://speech.microsoft.com/portal/voicegallery',
          component: "Switch",
        },
        {
          ...
          label: "Azure情绪纠正",
          bottomHelpMessage:
            "当机器人未使用或使用了不支持的说话风格时，将在对话中提醒机器人。注意：bing模式开启此项后有概率增大触发抱歉的机率，且不要单独开启此项。",
          component: "Switch",
        },
        {
        ...
        },
        {
          ...
          label: "云转码API地址",
          bottomHelpMessage:
            "目前只支持node-silk语音转码，可在本地node-silk无法使用时尝试使用云端资源转码",
          component: "Input",
        },
        {
          field: "cloudMode",
          label: "云转码API发送数据模式",
          bottomHelpMessage:
            "默认发送数据链接，如果你部署的是本地vits服务或使用的是微软azure，请改为文件",
          component: "Select",
          componentProps: {
            options: [
              { label: "文件", value: "file" },
        ...
        },
        {
          ...
          label: "系统Api服务端口",
          bottomHelpMessage:
            "系统Api服务开启的端口号，如需外网访问请将系统防火墙和服务器防火墙对应端口开放,修改后请重启",
          component: "InputNumber",
        },
        {
          field: "serverHost",
          label: "系统服务访问域名",
          bottomHelpMessage:
            "使用域名代替公网ip，适用于有服务器和域名的朋友避免暴露ip使用",
          component: "Input",
        },
        {
          field: "viewHost",
        ...
        },
        {
          ...
          label: "云渲染",
          bottomHelpMessage:
            "是否使用云资源进行图片渲染，需要开放服务器端口后才能使用，不支持旧版本渲染",
          component: "Switch",
        },
        {
        ...
        },
        {
          ...
          label: "额外工具url",
          bottomHelpMessage:
            "（测试期间提供一个公益接口，一段时间后撤掉）参考搭建：https://github.com/ikechan8370/chatgpt-plugin-extras",
          component: "Input",
        },
      ],
      // 获取配置数据方法（用于前端填充显示数据）
